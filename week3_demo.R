...
# Show all missing values for age attribute
...
# VIM package includes the aggr() function
# to show the number of missing values 
# for each variable and for variable combination
...
# Matrixplot shows missing data codded in red
matrixplot(managers, xlab = "Item", ylab = "Index", 
           main = "Identifiying missing values in managers dataset")
...
# 1 = perfrect positive correlation
# -1 = perfrect negative correlation
